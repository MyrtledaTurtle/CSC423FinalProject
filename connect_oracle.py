...
#Display all Requirements using at least two special equipment
def QueryOne():
	cursor.execute("""
    SELECT * 
    FROM REQUIREMENT 
    WHERE numofEqpt > = 2
    """)
#Display Equipment in Order by Price. LOWEST TO HIGHEST
def QueryTwo():
	cursor.execute("""
    SELECT *
    FROM EQUIPMENT
    ...
    """)
#Display Equipment and Equipment infro that costs less than $100
def QueryThree():
	cursor.execute("""
    SELECT *
    FROM EQUIPMENT
    ...
    """)
#Display the ClientNo, cleaning Days, start time and end time for each Requirement. Order by ClientNo
def QueryFour():
	cursor.execute("""
    ...
    ORDER BY ClientNo
    """)
#List all staff first last names and telephone numbers.
def QueryFive():
	cursor.execute("""
...
print("3. Display Equipment and Equipment infro that costs less than $100 ")
print("4. Display the ClientNo, cleaning Days, start time and end time for each Requirement. Order by ClientNo")
print("5. List all staff first last names and telephone numbers.")
